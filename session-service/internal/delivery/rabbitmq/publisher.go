...
func (client *RabbitMQClient) PublishPushNotificationEvent(ctx context.Context, arg domain.BaseEvent) error {
	return client.publishMessage(ctx, notificationQueueConfig.Queue, notificationQueueConfig.RoutingKeys[0], arg)
}