...
goog.exportSymbol('proto.user.LastReadMessage', null, global);
 ...
 * @constructor
 */
proto.user.LastReadMessage = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.user.LastReadMessage, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.user.LastReadMessage.displayName = 'proto.user.LastReadMessage';
}
...
proto.user.Users.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.user.UserMetadata.toObject, includeInstance)
  };
 ...
 * @return {!Array<!proto.user.UserMetadata>}
 */
proto.user.Users.prototype.getUsersList = function() {
  return /** @type{!Array<!proto.user.UserMetadata>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.user.UserMetadata, 1));
};


/**
 * @param {!Array<!proto.user.UserMetadata>} value
...
/**
 * @param {!proto.user.UserMetadata=} opt_value
 * @param {number=} opt_index
 * @return {!proto.user.UserMetadata}
 */
proto.user.Users.prototype.addUsers = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.user.UserMetadata, opt_index);
};
...
proto.user.NewFriend.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    friendname: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
 ...
 * @return {string}
 */
proto.user.NewFriend.prototype.getFriendname = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.user.NewFriend} returns this
 */
proto.user.NewFriend.prototype.setFriendname = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.user.Friend.prototype.getFriendname = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.user.Friend} returns this
 */
proto.user.Friend.prototype.setFriendname = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {!Array<string>}
 */
proto.user.UserIds.prototype.getUseridsList = function() {
 ...
 */
proto.user.UserIds.prototype.setUseridsList = function(value) {
 ...
 * @return {!proto.user.UserIds} returns this
 */
proto.user.UserIds.prototype.addUserids = function(value, opt_index) {
 ...
 * @return {!proto.user.UserIds} returns this
 */
proto.user.UserIds.prototype.clearUseridsList = function() {
 ...
 * @return {!Object}
 */
proto.user.LastReadMessage.prototype.toObject = function(opt_includeInstance) {
  return proto.user.LastReadMessage.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.user.LastReadMessage} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.user.LastReadMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    userid: jspb.Message.getFieldWithDefault(msg, 1, ""),
    channelid: jspb.Message.getFieldWithDefault(msg, 2, ""),
    lastmessageid: jspb.Message.getFieldWithDefault(msg, 3, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.user.LastReadMessage}
 */
proto.user.LastReadMessage.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.user.LastReadMessage;
  return proto.user.LastReadMessage.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.user.LastReadMessage} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.user.LastReadMessage}
 */
proto.user.LastReadMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.user.LastReadMessage.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.user.LastReadMessage.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.user.LastReadMessage} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.user.LastReadMessage.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserid();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.user.LastReadMessage.prototype.getUserid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.user.LastReadMessage} returns this
 */
proto.user.LastReadMessage.prototype.setUserid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.user.LastReadMessage.prototype.getChannelid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.user.LastReadMessage} returns this
 */
proto.user.LastReadMessage.prototype.setChannelid = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.user.LastReadMessage.prototype.getLastmessageid = function() {
 ...
 * @return {!proto.user.LastReadMessage} returns this
 */
proto.user.LastReadMessage.prototype.setLastmessageid = function(value) {
